  ...
  return (
    <div className="flex h-screen w-screen flex-col items-center justify-center overflow-hidden">
      <h1
        ...
        className="m-0 -translate-x-5 bg-clip-text px-20 text-[52vw] font-medium leading-[1em] tracking-[-.09em] text-transparent"
      >
        BKGD
      </h1>
      <p className="z-10 text-xl font-medium text-white">
