    ...
    <>
      <div className="relative flex h-[80vh] w-full flex-col items-center justify-center overflow-hidden">
        <div className="absolute left-0 top-0 inline-flex w-full items-center justify-center p-4">
          <a href="#about-bkgd">What is BKGD.APP?</a>
        </div>
        <h1
      ...
      <div className="flex w-full flex-col items-center">
        <a
          ...
          href="/"
          className="group inline-grid w-auto grid-flow-col grid-cols-[auto_0fr] items-stretch overflow-hidden rounded-lg bg-pink-500 bg-opacity-10 text-xl uppercase transition-all hover:grid-cols-[auto_1fr]"
        >
        ...
        <div className="my-24 inline-grid w-3/4 grid-cols-3 items-center justify-center gap-4">
